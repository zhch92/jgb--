...
/***/ function(module, exports, __webpack_require__) {
	...
	Page({
	    ...
	    setOrganName: function setOrganName(e) {
	    ...
	    setRealName: function setRealName(e) {
	        var val = e.detail.value;
	        this.setData({
	            realName: val
	        });
	    ...
	    setImageVerifiCode: function setImageVerifiCode(e) {
	        var val = e.detail.value;
	        this.setData({
	            imageVerifiCode: val
	        });
	    },
	    setTelVerifiCode: function setTelVerifiCode(e) {
	        var val = e.detail.value;
	        this.setData({
	            telVerifiCode: val
	        });
	    },
	    setPasswd: function setPasswd(e) {
	        var val = e.detail.value;
	        this.setData({
	            passwd: val,
	    ...
	    setVerifiPasswd: function setVerifiPasswd(e) {
	        var val = e.detail.value;
	        this.setData({
	            verifiPasswd: val
	        });
	    ...
	    gainMsg: function gainMsg() {
	        ...
	        console.log(typeof mobile1 === 'undefined' ? 'undefined' : (0, _typeof3.default)(mobile1));
	        if (!mobile) {
	            util.hint('请填写手机号码');
	        } else {
	    ...
	    refreshImg: function refreshImg() {
	        var src = 'http://10.10.10.204/jgb-web/v1/captcha?v=';
	    ...
	    refer: function refer() {
	        ...
	        var organName = $thisData.organName;
	        var realName = $thisData.realName;
	        var telphone = $thisData.telphone;
	        var imageVerifiCode = $thisData.imageVerifiCode;
	        var telVerifiCode = $thisData.telVerifiCode;
	        var passwd = $thisData.passwd;
	        var verifiPasswd = $thisData.verifiPasswd;
	        var checkbox = $thisData.checkbox;
	        if (!organName) {
	            util.hint('请填写公司名称');
	        } else if (!realName) {
	            util.hint('请填写联系人');
